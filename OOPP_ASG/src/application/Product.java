...
public abstract class Product {
	...
	public String toString() {
		return "Item number : " + getItemNum() + "Product name : " + getName() + "Quantity available :" + getQty() + "Price (RM) : " + getPrice() + 
				"Inventory value (RM) : " +  getTotalInventoryValue() + "Product status: " + status;
